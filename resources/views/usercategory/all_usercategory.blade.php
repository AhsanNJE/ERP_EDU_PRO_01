...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">All User Category</h3>
  </div>
  <!-- /.card-header -->
  <div class="card-body">
  ...
  <a href="{{ route('add.usercategory') }}" class="btn btn-info">Add User Category</a>
      <div class="row">
        <div class="col-sm-12">
          <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed"role="grid" aria-describedby="example1_info">
            <thead>
              <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Category Status</th>
            ...
            <tbody>
              ...
              <tr class="odd">
                ...
                <td>
              @if($item->status==1)
              <a href="{{ Route('user.category.status',$item->id) }}" class="btn btn-success btn-sm"><i class="fa-solid fa-check"></i>Active</a>
              @else
                  <a href="{{ Route('user.category.status',$item->id) }}" class="btn btn-danger btn-sm">Inactive</a>
              @endif
                </td>
                <td style="display: none;">

                <a href="{{ Route('edit.usercategory',$item->id) }}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i>Edit</a>

                <a href="{{ Route('delete.usercategory',$item->id) }}" class="btn btn-danger btn-sm" id="delete"><i class="fas fa-trash"></i>Delete</a>
            ...
            <tfoot>
              <tr>
                ...
                <th rowspan="1" colspan="1">Category Status</th>
